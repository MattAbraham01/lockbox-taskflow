...
export const ACTIVITY_TYPES = [
  { type: ActivityType.Running, label: "🏃 Running", unit: "minutes", color: "from-blue-500 to-cyan-500" },
  { type: ActivityType.Cycling, label: "🚴 Cycling", unit: "minutes", color: "from-green-500 to-emerald-500" },
  { type: ActivityType.Swimming, label: "🏊 Swimming", unit: "minutes", color: "from-blue-600 to-indigo-600" },
  { type: ActivityType.Weightlifting, label: "🏋️ Weightlifting", unit: "minutes", color: "from-red-500 to-pink-500" },
  { type: ActivityType.Yoga, label: "🧘 Yoga", unit: "minutes", color: "from-purple-500 to-violet-500" },
  { type: ActivityType.Walking, label: "🚶 Walking", unit: "minutes", color: "from-yellow-500 to-orange-500" },
];
